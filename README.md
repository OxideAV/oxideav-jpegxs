...
* `encoder` — rounds 1-7: forward 5/3 DWT (Annex E.13) per
  ...
  `⌈Np,y / Hsl⌉`-ways) via `encode_planar_hsl`; short packet
...
* Encoder round 104+: per-band per-precinct Q rate-distortion
