...
* `oxideav_jpegxs::encoder::encode_planar_subsampled(width, height,
  ...
  `⌈width / sx[i]⌉ * ⌈height / sy[i]⌉` (§B.1 ceiling, round 282 — odd
  picture dimensions are legal). Supports 4:4:4 / 4:2:2 / 4:2:0
